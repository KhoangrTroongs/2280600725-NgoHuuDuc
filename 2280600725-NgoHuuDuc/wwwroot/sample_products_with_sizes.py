...
for i in range(100):
    ...
    for size in sizes:
        # Generate random quantity for each size (0-20)
    ...
    product_data = {
        ...
        "Giá": price,
        "Size S": size_quantities["S"],
        "Size M": size_quantities["M"],
        "Size L": size_quantities["L"],
        "Size XL": size_quantities["XL"],
        "Size 2XL": size_quantities["2XL"],
